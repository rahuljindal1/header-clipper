// Message types
export const MSG_GET_ALL_REQUEST_HEADERS = "GET_ALL_REQUEST_HEADERS";
export const MSG_GET_REQUEST_HEADER_VALUE = "GET_REQUEST_HEADER_VALUE";
...
export const PREF_BADGE_MODE = "badgeMode";
